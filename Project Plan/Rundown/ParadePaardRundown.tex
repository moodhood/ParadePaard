...
The user can fill in the required fields, choose a contract preference such as on-call, fixed hours, temporary event work, or no preference, add one optional note for the reviewer, attach a CV if they want, and submit the application. Before submitting, the user must confirm that ParadePaard may contact them about the application and that the information is accurate.
