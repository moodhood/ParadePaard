...
When the employee finishes setup, the account moves to \code{PENDING_PROFILE_REVIEW}. The employee has completed their own part, but the account is not treated as active payroll-ready work until management reviews the profile and the contract flow is completed.
