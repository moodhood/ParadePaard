...
The page shows grouped sections for personal details, work interest, and confirmation. Personal details include full first names, preferred name, prefix, surname, email address, phone number, date of birth, gender, nationality, current city, and current country. Work interest includes role interest, contract preference, availability or start date, availability notes, relevant experience, languages, certificates, whether the applicant has worked for ParadePaard before, a short motivation, and an optional CV upload. The date of birth and availability or start date fields ask the applicant to enter dates as \code{dd/mm/yyyy}. When the applicant types digits into these fields, the slashes are added automatically so a date such as 03022000 becomes 03/02/2000.

The user can fill in the required fields, choose a contract preference such as on-call, fixed hours, temporary event work, or no preference, add practical background details for the reviewer, attach a CV if they want, and submit the application. Before submitting, the user must confirm that ParadePaard may contact them about the application and that the information is accurate.
