...
The page shows grouped sections for personal details, work interest, and confirmation. Personal details include full first names, preferred name, prefix, surname, email address, phone number, date of birth, gender, nationality, current city, and current country. Work interest includes role interest, contract preference, availability or start date, availability notes, relevant experience, languages, certificates, whether the applicant has worked for ParadePaard before, a short motivation, and an optional CV upload.
