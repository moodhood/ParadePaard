...
The accepted-applicant onboarding data contract has been expanded for the private onboarding flow. The setup service now supports the bank account holder name, BSN, payroll tax reduction choice, pension participation, special Zvw contribution, payroll notes, nationality, ID document type, ID document number, ID issue date, ID expiration date, ID issuing country, ID document image upload, and emergency contact name, relationship, phone, and optional email. These sensitive details are collected only after an applicant has been accepted and is completing private onboarding, not on the public application page. The visible onboarding form is still expanded in a later task, so this update prepares the data flow without redesigning the page in this step.
