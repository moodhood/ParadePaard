...
The contract email button points directly to this route. If the backend is still configured with the older Employment Details URL, the email link is still converted to the correct contract signing route so employees do not land on a broken nested account URL.
...
\begin{itemize}
    \item 2026 05 15: Fixed resent contract emails so old Employment Details URL configuration still opens the dedicated contract signing page.
